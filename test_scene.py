...
town_0 = scene.GameScene(*tilemap.load('data/m_town.json'), hero_position=Vect(100, 4))
stage1_0 = scene.GameScene(*tilemap.load('data/m_stage1.json'), hero_position=Vect(4, 4))
intermission1_2_0 = scene.TextScene(None, texts['intermission-1to2'], font)
stage2_0 = scene.GameScene(*tilemap.load('data/m_stage2.json'), hero_position=Vect(4, 36))
intermission2_3_0 = scene.TextScene(None, texts['intermission-2to3'], font)
stage3_0 = scene.GameScene(*tilemap.load('data/m_stage3.json'), hero_position=Vect(244, 8))
intermission3_2_1 = scene.TextScene(None, texts['intermission-3to2+'], font)
stage2_1 = scene.GameScene(*tilemap.load('data/m_stage2_n.json'), hero_position=Vect(248, 48))
intermission2_1_1 = scene.TextScene(None, texts['intermission-2+to1+'], font)
stage1_1 = scene.GameScene(*tilemap.load('data/m_stage1_n.json'), hero_position=Vect(248, 36))
town_1 = scene.GameScene(*tilemap.load('data/m_town_n.json'), hero_position=Vect(248, 4))
stage1_2 = scene.GameScene(*tilemap.load('data/m_stage1_n.json'), hero_position=Vect(4, 4))
intermission1_2_2 = scene.TextScene(None, texts['intermission-1++to2++'], font)
stage2_2 = scene.GameScene(*tilemap.load('data/m_stage2_n.json'), hero_position=Vect(4, 36))
intermission2_3_2 = scene.TextScene(None, texts['intermission-2++to3++'], font)
stage3_2 = scene.GameScene(*tilemap.load('data/m_stage3_n.json'), hero_position=Vect(244, 8))
stage2_3 = scene.GameScene(*tilemap.load('data/m_stage2.json'), hero_position=Vect(248, 48))
stage1_3 = scene.GameScene(*tilemap.load('data/m_stage1.json'), hero_position=Vect(248, 36))
